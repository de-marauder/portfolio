...
export default function About() {
  return (
      ...
      >
        ...
        >
          Hello, my name is{" "}
          <span className={classes2.Name}>Ezike Obiajulu Godson.</span>&nbsp; 
          <span>I am a self taught software developer with an academic background in
          chemical engineering and skills in</span>&nbsp;
        ...
        >
          ...
          responsiveness and optimization of websites is something I take pride
          in. I constantly strive to improve my skills.
        </motion.p>
        <br />
        <motion.p
          className={classes2.P}
