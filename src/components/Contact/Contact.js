                ...
                <AnimatePresence>
                    <form onSubmit={(e) => {
                        ...
                        <motion.input
                            ...
                            type='text' name='name' value={name} onChange={(e) => setName(e.target.value)} required placeholder='Name' />
                        <ValidationError
                            prefix="Name"
                            field="name"
                        ...
                        />
                        <motion.input
                            initial={{ opacity: 0, translateX: '-100%', animation: { delay: 2.1 } }}
                            animate={{ opacity: 1, translateX: 0 }}
                            exit={{ opacity: 0, animation: { delay: 1 } }}
                            type='email' name='email' value={email} onChange={(e) => setEmail(e.target.value)} required placeholder='E-mail' />
                        <ValidationError
                            prefix="Email"
                            field="email"
                            errors={submit.errors}
                        ...
                        />
                        <motion.input
                            initial={{ opacity: 0, translateX: '-100%', animation: { delay: 3.2 } }}
                            animate={{ opacity: 1, translateX: 0 }}
                            exit={{ opacity: 0, animation: { delay: 1 } }}
                            type='text' name='subject' value={subject} onChange={(e) => setSubject(e.target.value)} required placeholder='Subject' />
                        <ValidationError
                            prefix="Subject"
                            field="subject"
                            errors={submit.errors}
                        ...
                        />
                        <motion.textarea
                            initial={{ opacity: 0, translateX: '-100%', animation: { delay: 4.3 } }}
                            animate={{ opacity: 1, translateX: 0 }}
                            exit={{ opacity: 0, animation: { delay: 1 } }}
                            type='text' name='message' value={message} onChange={(e) => setMessage(e.target.value)} required rows={4} placeholder='Message' />
                        <ValidationError
                            prefix="Message"
                            field="messagge"
                            errors={submit.errors}
